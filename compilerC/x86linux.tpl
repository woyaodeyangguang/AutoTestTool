/*
**X86 Assembly Templates for HCC 1.0
...
TEMPLATE(X86_ORI4,     "orl %2, %0")
TEMPLATE(X86_ORU4,     "orl %2, %0")
TEMPLATE(X86_ORF4,     NULL)
TEMPLATE(X86_ORF8,     NULL)

TEMPLATE(X86_XORI4,    "xorl %2, %0")
TEMPLATE(X86_XORU4,    "xorl %2, %0")
TEMPLATE(X86_XORF4,    NULL)
TEMPLATE(X86_XORF8,    NULL)

TEMPLATE(X86_ANDI4,    "andl %2, %0")
TEMPLATE(X86_ANDU4,    "andl %2, %0")
TEMPLATE(X86_ANDF4,    NULL)
TEMPLATE(X86_ANDF8,    NULL)
...
TEMPLATE(X86_JGF4,     "flds %2;fcompp;fnstsw %%ax;test $0x1, %%ah;jne %0")
TEMPLATE(X86_JGF8,     "fldl %2;fcompp;fnstsw %%ax;test $0x1, %%ah;jne %0")

TEMPLATE(X86_JLI4,     "cmpl %2, %1;jl %0")
TEMPLATE(X86_JLU4,     "cmpl %2, %1;jb %0")
TEMPLATE(X86_JLF4,     "flds %2;fcompp;fnstsw %%ax;test $0x41, %%ah;jp %0")
TEMPLATE(X86_JLF8,     "fldl %2;fcompp;fnstsw %%ax;test $0x41, %%ah;jp %0")

TEMPLATE(X86_JGEI4,    "cmpl %2, %1;jge %0")
TEMPLATE(X86_JGEU4,    "cmpl %2, %1;jae %0")
TEMPLATE(X86_JGEF4,    "flds %2;fcompp;fnstsw %%ax;test $0x41, %%ah;jne %0")
TEMPLATE(X86_JGEF8,    "fldl %2;fcompp;fnstsw %%ax;test $0x41, %%ah;jne %0")

TEMPLATE(X86_JLEI4,    "cmpl %2, %1;jle %0")
TEMPLATE(X86_JLEU4,    "cmpl %2, %1;jbe %0")
TEMPLATE(X86_JLEF4,    "flds %2;fcompp;fnstsw %%ax;test $0x5, %%ah;jp %0")
TEMPLATE(X86_JLEF8,    "fldl %2;fcompp;fnstsw %%ax;test $0x5, %%ah;jp %0")

//TEMPLATE(X86_EXTI1,    "movsbl %1, %0")
TEMPLATE(X86_CVTI1I4,  "movsbl %1, %0")
TEMPLATE(X86_CVTI1U4,  "movsbl %1, %0")
//TEMPLATE(X86_EXTU1,    "movzbl %1, %0")
TEMPLATE(X86_CVTU1I4,  "movzbl %1, %0")
TEMPLATE(X86_CVTU1U4,  "movzbl %1, %0")
//TEMPLATE(X86_EXTI2,    "movswl %1, %0")
TEMPLATE(X86_CVTI2I4,  "movswl %1, %0")
TEMPLATE(X86_CVTI2U4,  "movswl %1, %0")
//TEMPLATE(X86_EXTU2,    "movzwl %1, %0")
TEMPLATE(X86_CVTU2I4,  "movzwl %1, %0")
TEMPLATE(X86_CVTU2U4,  "movzwl %1, %0")
//TEMPLATE(X86_TRUI1,    "movb %%al, %0")
TEMPLATE(X86_CVTI4I1,  "movb %%al, %0")
TEMPLATE(X86_CVTI4U1,  "movb %%al, %0")
//TEMPLATE(X86_TRUI2,    "movb %%al, %0")
TEMPLATE(X86_CVTI4I2,  "movw %%ax, %0")
TEMPLATE(X86_CVTI4U2,  "movw %%ax, %0")
TEMPLATE(X86_CVTI4F4,  "pushl %1;filds (%%esp);fstps %0;addl $4,%%esp")
TEMPLATE(X86_CVTI4F8,  "pushl %1;fildl (%%esp);fstpl %0;addl $4,%%esp")
TEMPLATE(X86_CVTU4F4,  "pushl $0;pushl %1;fildl (%%esp);fstps %0;addl $8,%%esp")
TEMPLATE(X86_CVTU4F8,  "pushl $0;pushl %1;fildl (%%esp);fstpl %0;addl $8,%%esp")
TEMPLATE(X86_CVTF4F8,    "flds %1;fstpl %0")
TEMPLATE(X86_CVTF8F4,    "fldl %1;fstps %0")
TEMPLATE(X86_CVTF4I4,  "flds %1;subl $8, %%esp;fnstcw 6(%%esp);movzwl 6(%%esp), %%eax;"
                       "orl $0x0c00, %%eax;movw %%ax, 4(%%esp);fldcw 4(%%esp);fistpl (%%esp);"
                       "fldcw 6(%%esp);movl (%%esp), %%eax;addl $8, %%esp")
...
TEMPLATE(X86_CVTF8I4,  "fldl %1;subl $8, %%esp;fnstcw 6(%%esp);movzwl 6(%%esp), %%eax;"
                       "orl $0x0c00, %%eax;movw %%ax, 4(%%esp);fldcw 4(%%esp);fistpl (%%esp);"
                       "fldcw 6(%%esp);movl (%%esp),%%eax;addl $8, %%esp")
...
TEMPLATE(X86_INCF8,    "fldl faddl %0;fstpl %0")
...
TEMPLATE(X86_DECF4,    "fld1;fsubs %0;fabs;fstps %0")
TEMPLATE(X86_DECF8,    "fldl fsubl %0;fabs;fstpl %0")
...
TEMPLATE(X86_CLEAR,    "subl $12, %%esp;pushl %1;pushl $0;leal %0, %%eax;pushl %%eax;call memset;addl $12, %%esp")
